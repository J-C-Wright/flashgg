...
lumiMask=/home/hep/jw3914/Work/VBF_Zee/CMSSW_8_0_20/src/flashgg/Taggers/test/VBF-MORIOND-2017/lumi_mask_rereco.json
jsonfile=/home/hep/jw3914/Work/VBF_Zee/CMSSW_8_0_20/src/flashgg/Taggers/test/VBF-MORIOND-2017/control_pujid_rereco.json

for wp in "medium" # "tight" "medium" "loose"
do 
    today=`date +%F`
    outdir=/vols/cms/jwright/VBF_Zee/vbf-trees-RunII16Fall-80x/pujid-control-rereco-${wp}-${today}
