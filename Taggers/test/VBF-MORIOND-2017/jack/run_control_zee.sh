...
do 
    today=`date +%F`
    outdir=/vols/cms/jwright/VBF_Zee/vbf-trees-RunII16Fall-80x/pujid-control-ZeeJetSys-${wp}-${today}
    fggRunJobs.py --load ${jsonfile} -d ${outdir} \
		  -x cmsRun cmsRun ZPlusJetDumper_cfg.py  maxEvents=-1 doJetSystTrees=False \
