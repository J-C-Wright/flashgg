...
if customize.processId == "Data":
    process.jec.connect = cms.string('sqlite_file:%s/src/flashgg/Systematics/data/JEC/Spring16_23Sep2016AllV2_DATA.db' % os.environ['CMSSW_BASE'])
