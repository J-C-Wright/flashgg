...
all_variables = var.variable_exploration + var.dipho_variables
if customize.processId != "Data":
...
if customize.runOnZee:
    if customize.processId == "Data":
        ...
        process.hltHighLevel = hltHighLevel.clone(HLTPaths = cms.vstring("HLT_Ele35_WPLoose_Gsf_v*"))

        # Only exists in some runs
